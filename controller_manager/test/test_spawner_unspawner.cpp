...
TEST_F(TestLoadController, spawner_test_type_in_param)
{
  ...
  ASSERT_EQ(ctrl_1.c->get_state_id(), lifecycle_msgs::msg::State::PRIMARY_STATE_ACTIVE);
...
TEST_F(TestLoadController, spawner_test_type_in_arg)
{
  ...
  ASSERT_EQ(ctrl_2.c->get_state_id(), lifecycle_msgs::msg::State::PRIMARY_STATE_ACTIVE);
}
